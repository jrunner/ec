package com.t2t.top.base.utils.zip;
...
public class ZipManager {
	...
	protected static Logger logger = LoggerFactory.getLogger(ZipManager.class);
	 ...
	 * @param targetFile 压缩后的文件(可以是不存在的)
	 */
	...
	private int zipping(File zipFile, ZipOutputStream zos, ZipEntry zip, byte[] buf, int readLen) throws IOException {
		logger.info("压缩文件: " + zipFile.getAbsolutePath());
